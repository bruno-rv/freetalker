...
enum SpeechModelCatalog {
    ...
    static let entries: [SpeechModelCatalogEntry] = [
        .init(
            id: "openai_whisper-tiny", displayName: "Whisper Tiny", approximateSize: "~150 MB", compactTradeoff: "fastest",
        ...
        .init(
            id: "openai_whisper-base", displayName: "Whisper Base", approximateSize: "~290 MB", compactTradeoff: "fast and compact",
            quickTip: "Very fast and compact, with better accuracy than Tiny. Best for everyday short dictation. ID: openai_whisper-base",
            isMultilingual: true
        ),
        .init(
            id: "openai_whisper-small", displayName: "Whisper Small", approximateSize: "~580 MB", compactTradeoff: "fast and compact",
        ...
        .init(
            id: "openai_whisper-medium", displayName: "Whisper Medium", approximateSize: "~1.5 GB", compactTradeoff: "balanced",
        ...
        .init(
            id: "openai_whisper-large-v3_947MB", displayName: "Whisper Large v3", approximateSize: "~947 MB", compactTradeoff: "most accurate",
        ...
        .init(
            ...
            displayName: "Whisper Large v3 Turbo (632 MB)", approximateSize: "~632 MB", compactTradeoff: "faster large-model transcription",
        ...
        .init(
            id: defaultID, displayName: "Whisper Large v3 Turbo", approximateSize: "~954 MB", compactTradeoff: "faster large-model transcription",
