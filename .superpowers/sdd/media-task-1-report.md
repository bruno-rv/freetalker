...
- Added a framework-independent timeline joiner that assigns the speaker with the
  greatest positive temporal overlap. Equal overlap resolves by input turn order.
...
All commands exited 0. `make test` passed 177 tests in 18 suites. `make app`
